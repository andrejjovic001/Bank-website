...
//       if (el !== link) el.style.opacity = this; // Napravi da opacity bude 0.5
//     });
//     logo.style.opacity = this;  // Napravi da opacity bude 0.8
//   }
// } 
...
nav.addEventListener('mouseover', handleHover.bind([0.5, 0.8]));  // 0.5 je zapravo rijec this i this koristimo za opacity
